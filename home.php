...
<div class="landing-page">
	...
	<div class="main">
		...
		<section class="lazy s1" id="s1" data-bg="<?php echo THEME_URL  ?>/assets/images/s1-bg.png">
			<div class="s1-wrapper">
				<img class="lazy" data-src="<?php echo THEME_URL  ?>/assets/images/s1-title.png" />
			</div>
		</section>

		<section class="lazy s2" id="s2" data-bg="<?php echo THEME_URL  ?>/assets/images/s2-bg.png">
		...
		<section class="lazy s3" id="s3" data-bg="<?php echo THEME_URL  ?>/assets/images/s3-bg.png">
